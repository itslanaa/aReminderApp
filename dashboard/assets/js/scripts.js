...
jQuery(function($) {
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    DASH_SETTINGS.windowBasedLayout = function() {
        var width = window.innerWidth;
        //console.log(width);

        if ($("body").hasClass("chat-open") || $("body").hasClass("sidebar-collapse")) {

            DASH_SETTINGS.mainmenuCollapsed();
    ...
    /*--------------------------------
         Window Based Layout
     --------------------------------*/
    DASH_SETTINGS.onLoadTopBar = function() {
    ...
    /*--------------------------------
         CHAT API
     --------------------------------*/
    DASH_SETTINGS.chatAPI = function() {
        ...
        $('.page-topbar .toggle_chat').on('click', function() {
            ...
            if (chatarea.hasClass("hideit")) {
                ...
                //DASH_SETTINGS.mainmenuScroll();
                DASH_SETTINGS.windowBasedLayout();
            }
        });
    ...
    /*--------------------------------
         CHAT API Scroll
     --------------------------------*/
    DASH_SETTINGS.chatApiScroll = function() {
    ...
    /*--------------------------------
         CHAT API window
     --------------------------------*/
    DASH_SETTINGS.chatApiWindow = function() {
        ...
        $(document).on('click', ".chatapi-windows .user-window .controlbar img, .chatapi-windows .user-window .controlbar .minimizeit", function(e) {
            ...
            if (!$(".chatapi-windows #user-window" + id).hasClass("minimizeit")) {
                ...
                DASH_SETTINGS.tooltipsPopovers();
            } else {
    ...
    /*--------------------------------
         Login Page
     --------------------------------*/
    DASH_SETTINGS.loginPage = function() {
    ...
    /*--------------------------------
         Search Page
     --------------------------------*/
    DASH_SETTINGS.searchPage = function() {
    ...
    /*--------------------------------
        Viewport Checker
     --------------------------------*/
    DASH_SETTINGS.viewportElement = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.draggablePanels = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.breadcrumbAutoHidden = function() {
    ...
    /*--------------------------------
         Section Box Actions
     --------------------------------*/
    DASH_SETTINGS.sectionBoxActions = function() {
    ...
    /*--------------------------------
         Main Menu Scroll
     --------------------------------*/
    DASH_SETTINGS.mainmenuScroll = function() {
    ...
    /*--------------------------------
         Collapsed Main Menu
     --------------------------------*/
    DASH_SETTINGS.mainmenuCollapsed = function() {
    ...
    /*--------------------------------
         Main Menu
     --------------------------------*/
    DASH_SETTINGS.mainMenu = function() {
    ...
    /*--------------------------------
         Mailbox
     --------------------------------*/
    DASH_SETTINGS.mailboxInbox = function() {
    ...
    /*--------------------------------
         Top Bar
     --------------------------------*/
    DASH_SETTINGS.pageTopBar = function() {
    ...
    /*--------------------------------
         Extra form settings
     --------------------------------*/
    DASH_SETTINGS.extraFormSettings = function() {
    ...
    /*--------------------------------
         js tree
     --------------------------------*/
    DASH_SETTINGS.jsTreeINIT = function() {
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    DASH_SETTINGS.jvectorMaps = function() {
    ...
    /*--------------------------------
         DataTables
     --------------------------------*/
    DASH_SETTINGS.dataTablesInit = function() {
    ...
    /*--------------------------------
         Pretty Photo
     --------------------------------*/
    DASH_SETTINGS.loadPrettyPhoto = function() {
    ...
    /*--------------------------------
         Gallery
     --------------------------------*/
    DASH_SETTINGS.isotopeGallery = function() {
    ...
    /*--------------------------------
         Tocify
     --------------------------------*/
    DASH_SETTINGS.tocifyScrollMenu = function() {
    ...
    /*--------------------------------
         Full Calendar
     --------------------------------*/
    DASH_SETTINGS.uiCalendar = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.nestableList = function() {
    ...
    /*--------------------------------
         Tooltips & Popovers
     --------------------------------*/
    DASH_SETTINGS.tooltipsPopovers = function() {
    ...
    /*--------------------------------
         Form Editors
     --------------------------------*/
    DASH_SETTINGS.formEditors = function() {
    ...
    /*--------------------------------
         Custom Dropzone
     --------------------------------*/
    DASH_SETTINGS.customDropZone = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.otherScripts = function() {
    ...
    /*--------------------------------
        Widgets
     --------------------------------*/
    DASH_SETTINGS.DASHWidgets = function() {
    ...
    /*--------------------------------
        weather widget
     --------------------------------*/
    DASH_SETTINGS.DASHWidgetWeather = function() {
    ...
    /*--------------------------------
        To Do Task Widget
     --------------------------------*/
    DASH_SETTINGS.DASHToDoWidget = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.DASHToDoAddTaskWidget = function() {
        ...
        $(".wid-add-task input").on('keypress', function(e) {
            if (e.keyCode == 13) {
                ...
                $(this).val("");
                $(this).focus();
                DASH_SETTINGS.iCheck();
                DASH_SETTINGS.DASHToDoWidget();
    ...
    /*--------------------------------
         Vector maps
     --------------------------------*/
    DASH_SETTINGS.dbjvectorMap = function() {
    ...
    /*--------------------------------
        IOS7 Switchery
     --------------------------------*/
    DASH_SETTINGS.ios7Switchery = function() {
    ...
    /*--------------------------------
     ...
     --------------------------------*/
    DASH_SETTINGS.widgetSparklineChart = function() {
    ...
    $(document).ready(function() {
        DASH_SETTINGS.windowBasedLayout();
        DASH_SETTINGS.mainmenuScroll();
        DASH_SETTINGS.mainMenu();
        DASH_SETTINGS.mainmenuCollapsed();
        DASH_SETTINGS.pageTopBar();
        DASH_SETTINGS.otherScripts();
        DASH_SETTINGS.iCheck();
        DASH_SETTINGS.customDropZone();
        DASH_SETTINGS.formEditors();
        DASH_SETTINGS.extraFormSettings();
        DASH_SETTINGS.tooltipsPopovers();
        DASH_SETTINGS.nestableList();
        DASH_SETTINGS.uiCalendar();
        DASH_SETTINGS.tocifyScrollMenu();
        DASH_SETTINGS.loadPrettyPhoto();
        DASH_SETTINGS.jvectorMaps();
        DASH_SETTINGS.dataTablesInit();
        DASH_SETTINGS.jsTreeINIT();
        DASH_SETTINGS.breadcrumbAutoHidden();
        DASH_SETTINGS.chatAPI();
        DASH_SETTINGS.chatApiScroll();
        DASH_SETTINGS.chatApiWindow();
        DASH_SETTINGS.mailboxInbox();
        DASH_SETTINGS.DASHWidgets();
        DASH_SETTINGS.sectionBoxActions();
        DASH_SETTINGS.draggablePanels();
        DASH_SETTINGS.viewportElement();
        DASH_SETTINGS.searchPage();
        DASH_SETTINGS.DASHToDoAddTaskWidget();
        DASH_SETTINGS.DASHToDoWidget();
        DASH_SETTINGS.dbjvectorMap();
        DASH_SETTINGS.widgetSparklineChart();
        DASH_SETTINGS.DASHWidgetWeather();
        DASH_SETTINGS.onLoadTopBar();
        DASH_SETTINGS.ios7Switchery();
        // ------------------------------------------------------- //
        // Coins Slider
        // ------------------------------------------------------ //
        if ($(".coins-slider")){
    ...
    $(window).resize(function() {
        ...
        //DASH_SETTINGS.mainmenuScroll();
        //DASH_SETTINGS.DASHWidgetWeather();
        DASH_SETTINGS.isotopeGallery();
        DASH_SETTINGS.loginPage();
        DASH_SETTINGS.widgetSparklineChart();
    });
