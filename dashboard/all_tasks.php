...
<head>
    ...
    <title>All Tasks - Task Manager App</title>
               ...
               $dateNow = date('Y-m-d');
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table vm table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                              ...
                                              <div class="modal-footer">
                                                 <button type="submit" name="markDone" class="btn btn-primary">Mark as Done</button>
                                                <button type="submit" name="editTask" class="btn btn-success">Edit</button>
                                              </div>
                                                <?php 
                                                } 
                                                ?>
                ...
                <div class="clearfix"></div>
                 ...
                 <div class="col-lg-12">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Tomorrow</h2>
                        </header>
                        <div class="content-body">
                            <div class="row">
                                <div class="col-xs-12">
                ...
                <div class="col-lg-12">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Upcoming</h2>
                        </header>
                        <div class="content-body">
                            <div class="row">
                                <div class="col-xs-12">
                                    ...
                                    <div class="table-responsive" data-pattern="priority-columns">
                                        <table id="tech-companies-1" class="table vm table-small-font no-mb table-bordered table-striped">
                                            ...
                                            $dateEnd = date('Y-m-d', strtotime('+365 day'));

                                            $qrySelect = mysqli_query($conn, "SELECT * FROM tb_task WHERE date(tt_reminder_date) BETWEEN '$dateNow' AND '$dateEnd' AND tt_tr_id ='$sessionTask'");
