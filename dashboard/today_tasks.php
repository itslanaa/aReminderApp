...
<head>
    ...
    <title>Today Tasks - Task Manager App</title>
...
?>
                ...
                <div class="col-lg-12">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title pull-left">Today</h2>
                        </header>
                                        ...
                                        <table id="tech-companies-1" class="table vm table-small-font no-mb table-bordered table-striped">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    while($taskRow = mysqli_fetch_assoc($qrySelect)){
                                              ...
                                              <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                  ...
                                                  <div class="form-group">
                                                    <label for="recipient-name" class="col-form-label">Title:</label>
                                                    <input type="text" class="form-control" name="taskTitle" maxlength="50" value="<?php echo $row['tt_title']; ?>" required>
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="message-text" class="col-form-label">Notes:</label>
                                                    <textarea class="form-control" name="taskNotes" minlength="10" required><?php echo $row['tt_description']; ?></textarea>
                                                  </div>
                                                  <div class="form-group">
                                                    <label for="datetime" class="col-form-label">Set Time:</label>
                                                    <input type="datetime-local" name="taskDtime" value="<?php echo $row['tt_reminder_date']; ?>" required>
                                                  </div>
                                                  <div class="form-group">
                                              ...
                                              <div class="modal-footer">
                                                ...
                                                <button type="submit" name="editTask" value="editTask" class="btn btn-info">Edit</button>
                                              </div>
                                                <?php 
                                                } 
                                                ?>
                                          ...
                                          <!-- START OF EDIT TASKS - BOOTSTRAP MODAL -->
                                               <!--  <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                          <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                              <div class="modal-header">
                                                                <h3 class="modal-title-delete" id="exampleModalLabel">Are you sure want to delete this task ?</h3>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                  <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        </div>
                                                        <div class="modal-body">click "delete" button below if you want to delete this task./</div>
                                                        <div class="modal-footer">
  ...
  var modal = $(this)
  modal.find('.modal-title-delete').text('Are you sure want to delete this task ?')
</script>
<script>
...
<script>
function gotoupdate(markDone){
    $.post("edit_task.php?id="+markDone, 
        function(data){
            $("#cdata").html(data);
    }); 
}
